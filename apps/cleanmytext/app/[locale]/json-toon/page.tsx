...
export default function JsonToonPage() {
  ...
  const [conversionMode, setConversionMode] = useState<'json-to-toon' | 'toon-to-json'>(
    'json-to-toon'
  );
                    ...
                    {inputText && (
                      <div className="flex items-center gap-2">
                        <div className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
                          {inputStats.characters} {t('characters')} • {inputStats.lines}{' '}
                          {t('lines')}
                        </div>
                        <Button
                          onClick={() =>
                            handleCopy(
                              inputText,
                              conversionMode === 'json-to-toon' ? 'JSON' : 'TOON'
                            )
                          }
                          size="sm"
                          variant="outline"
                ...
                <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-4 sm:p-6">
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    ...
                    {outputText && (
                      <div className="flex items-center gap-2">
                        <div className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
                          {outputStats.characters} {t('characters')} • {outputStats.lines}{' '}
                          {t('lines')}
                        </div>
                        <Button
                          onClick={() =>
